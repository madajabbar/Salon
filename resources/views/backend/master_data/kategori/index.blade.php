...
@section('content')
        ...
        <div class="page-content">
            <div class="card">
                ...
                @include('backend.master_data.kategori.__form')
            </div>
        </div>
@endsection
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        $('body').on('click', '.input', function() {
            $('#exampleModalCenterTitle').html("Add kategori");
        ...
        $('body').on('click', '.deleteProduct', function() {
            ...
            if (check == true) {
                $.ajax({
                    type: "DELETE",
                    url: "{{ route('kategori.store') }}" + '/' + data_id,
        ...
        $('body').on('click', '.editProduct', function() {
            var data_id = $(this).data('id');
            $.get("{{ route('kategori.index') }}" + '/' + data_id + '/edit', function(data) {
                $('#exampleModalCenterTitle').html("Edit kategori");
                $('#saveBtn').val("edit");
